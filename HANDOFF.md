...
- Current HF commit: `34241c2501e5fb7e7416322407f84b7705ebb013`
- Visibility: public
- Gated: false
...
| --- | --- | --- |
| `ollama` | `feat/lfm2-embed-output-norm` | Clean; pushed to `fork/feat/lfm2-embed-output-norm` at `4cb8d65b`; rebased onto current `origin/main`; upstream PR #16195 open and mergeable. |
